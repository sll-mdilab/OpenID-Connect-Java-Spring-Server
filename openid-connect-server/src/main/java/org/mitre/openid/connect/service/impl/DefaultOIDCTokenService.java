...
public class DefaultOIDCTokenService implements OIDCTokenService {
	...
	@Override
	public OAuth2AccessTokenEntity createIdToken(ClientDetailsEntity client, OAuth2Request request, Date issueTime, String sub, OAuth2AccessTokenEntity accessToken, String profile) {
		...
		//Added for SMART-support
		idClaims.claim("profile", profile);
